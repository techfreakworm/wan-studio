...
WAN_2_1: list[ModelCard] = [
    ...
    ModelCard(
        ...
        lightning_high_lora="Lightx2v/lightx2v_T2V_14B_cfg_step_distill_v2_lora_rank128_bf16.safetensors",
    ...
    ModelCard(
        ...
        lightning_high_lora="loras/Wan21_I2V_14B_lightx2v_cfg_step_distill_lora_rank64.safetensors",
...
WAN_2_2: list[ModelCard] = [
    ...
    ModelCard(
        ...
        lightning_available=True,
        lightning_lora_repo="Kijai/WanVideo_comfy",
        lightning_high_lora="LoRAs/Wan22-Lightning/old/Wan2.2-Lightning_I2V-A14B-4steps-lora_HIGH_fp16.safetensors",
        lightning_low_lora="LoRAs/Wan22-Lightning/old/Wan2.2-Lightning_I2V-A14B-4steps-lora_LOW_fp16.safetensors",
        lightning_steps=4, lightning_guidance=1.0,
